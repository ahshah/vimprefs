...
hi! BufTabLineCurrent   ctermbg=03  ctermfg=black cterm=bold
hi! BufTabLineActive    ctermbg=208 ctermfg=237  cterm=bold
...
" hi Sneak ctermfg=black ctermbg=red guifg=black guibg=red 
